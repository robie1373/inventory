...
Elm.InventoryUtils = Elm.InventoryUtils || {};
Elm.InventoryUtils.make = function (_elm) {
   "use strict";
   _elm.InventoryUtils = _elm.InventoryUtils || {};
   if (_elm.InventoryUtils.values) return _elm.InventoryUtils.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.InventoryUtils.values = {_op: _op,onInput: onInput,parseInt: parseInt};
};
...
Elm.Inventory.make = function (_elm) {
   ...
   $Html$Events = Elm.Html.Events.make(_elm),
   $InventoryUtils = Elm.InventoryUtils.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var UpdateFormCount = function (a) {    return {ctor: "UpdateFormCount",_0: a};};
   var UpdateFormPackage = function (a) {    return {ctor: "UpdateFormPackage",_0: a};};
   var UpdateFormDescription = function (a) {    return {ctor: "UpdateFormDescription",_0: a};};
   var AddItem = {ctor: "AddItem"};
   var NoOp = {ctor: "NoOp"};
   var isAddInvalid = function (model) {
      return $String.isEmpty(model.descriptionInput) || ($String.isEmpty(model.packageInput) || $String.isEmpty(model.countInput));
   };
   var newComponentForm = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([]),
              _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text(model.descriptionInput)]))
                      ,A2($Html.span,_U.list([]),_U.list([$Html.text(model.packageInput)]))
                      ,A2($Html.span,_U.list([]),_U.list([$Html.text(model.countInput)]))]))]))
              ,A2($Html.span,
              _U.list([]),
              ...
              _U.list([$Html$Attributes.type$("text")
                      ...
                      ,$Html$Attributes.value(model.descriptionInput)
                      ,A2($InventoryUtils.onInput,address,UpdateFormDescription)]),
              _U.list([]))]))
              ,A2($Html.span,
              _U.list([]),
              _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ,$Html$Attributes.placeholder("Package")
                      ,$Html$Attributes.name("package")
                      ,$Html$Attributes.value(model.packageInput)
                      ,A2($InventoryUtils.onInput,address,UpdateFormPackage)]),
              _U.list([]))]))
              ,A2($Html.span,
              _U.list([]),
              _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("number")
                      ,$Html$Attributes.placeholder("Count")
                      ,$Html$Attributes.value(model.countInput)
                      ,$Html$Attributes.name("count")
   ...
   var Model = F5(function (a,b,c,d,e) {    return {stock: a,descriptionInput: b,packageInput: c,countInput: d,nextID: e};});
   var StockItem = F4(function (a,b,c,d) {    return {description: a,$package: b,count: c,id: d};});
   var newStockItem = F4(function (description,$package,count,id) {    return A4(StockItem,description,$package,count,id);});
   var initialModel = {stock: _U.list([A4(newStockItem,"TopHat PCB","NA","10",1),A4(newStockItem,"1k Resistor","1208","56",2)])
                      ,descriptionInput: ""
                      ,packageInput: ""
                      ,countInput: ""
                      ,nextID: 3};
   ...
   return _elm.Inventory.values = {_op: _op
                                  ...
                                  ,UpdateFormPackage: UpdateFormPackage
